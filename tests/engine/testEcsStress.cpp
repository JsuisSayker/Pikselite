...
TEST(EcsStressTests, ComponentTypeAtExactLimit)
{
    ...
    for (std::size_t i = 0; i < ecs::MAX_COMPONENT_TYPES; ++i)
    {
        switch (i)
        {
        case 0:  cm.registerComponent<StressComp<0>>();  break;
        case 1:  cm.registerComponent<StressComp<1>>();  break;
        case 2:  cm.registerComponent<StressComp<2>>();  break;
        case 3:  cm.registerComponent<StressComp<3>>();  break;
        case 4:  cm.registerComponent<StressComp<4>>();  break;
        case 5:  cm.registerComponent<StressComp<5>>();  break;
        case 6:  cm.registerComponent<StressComp<6>>();  break;
        case 7:  cm.registerComponent<StressComp<7>>();  break;
        case 8:  cm.registerComponent<StressComp<8>>();  break;
        case 9:  cm.registerComponent<StressComp<9>>();  break;
        case 10: cm.registerComponent<StressComp<10>>(); break;
        case 11: cm.registerComponent<StressComp<11>>(); break;
        case 12: cm.registerComponent<StressComp<12>>(); break;
        case 13: cm.registerComponent<StressComp<13>>(); break;
        case 14: cm.registerComponent<StressComp<14>>(); break;
        case 15: cm.registerComponent<StressComp<15>>(); break;
        case 16: cm.registerComponent<StressComp<16>>(); break;
        case 17: cm.registerComponent<StressComp<17>>(); break;
        case 18: cm.registerComponent<StressComp<18>>(); break;
        case 19: cm.registerComponent<StressComp<19>>(); break;
        case 20: cm.registerComponent<StressComp<20>>(); break;
        case 21: cm.registerComponent<StressComp<21>>(); break;
        case 22: cm.registerComponent<StressComp<22>>(); break;
        case 23: cm.registerComponent<StressComp<23>>(); break;
        case 24: cm.registerComponent<StressComp<24>>(); break;
        case 25: cm.registerComponent<StressComp<25>>(); break;
        case 26: cm.registerComponent<StressComp<26>>(); break;
        case 27: cm.registerComponent<StressComp<27>>(); break;
        case 28: cm.registerComponent<StressComp<28>>(); break;
        case 29: cm.registerComponent<StressComp<29>>(); break;
        case 30: cm.registerComponent<StressComp<30>>(); break;
        case 31: cm.registerComponent<StressComp<31>>(); break;
        }
    }
...
TEST(EcsStressTests, ComponentArrayFullOverflow)
{
    ...
    EXPECT_THROW(
        componentManager.addComponent<ecs::components::Transform>(ecs::MAX_ENTITIES + 1, makeTransform(0.0f, 0.0f)),
        std::runtime_error);
}
...
TEST(EcsStressTests, TypeMismatchThrows)
{
    ...
    EXPECT_THROW(componentManager.getComponentType<ecs::components::Velocity>(), std::runtime_error);
}
