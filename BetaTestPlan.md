...
| F5             | Sprites can be created                                  | Sprite appears correctly in sprite editor                          | Done        |
| F6             | Sprites can be edited                                   | Pixel modifications are applied correctly                          | In Progress |
| F7             | Sprites can be saved                                    | Sprite file is correctly stored and reusable                       | Done        |
| F8             | Sprites can be loaded                                   | Sprite renders correctly with preserved Elements                   | Done        |
...
| F19            | Sprite game objects can be created in the current scene | Game object appears correctly in scene and viewport                | Done        |
| F20            | Pixel game objects can be created in the current scene  | Pixel object is added correctly to the scene                       | Done        |
...
| F28            | Velocity components can be added                        | Object movement velocity is applied correctly                      | Done        |
