...
namespace graphics {
    ...
    public:
        ...
        void pixelSpriteHandler(bool &showDefaultPropertiesEditor, bool &isEraserActive, std::string &saveSpritePath, std::vector<::Pixel::GameObject>* gameObjects = nullptr);
