 ...
 * The Interface class provides methods for creating a window, handling user input, and managing the OpenGL context.
 */
namespace graphics {
    class Interface {
        public:
            ...
            /**
             * @brief Polls for user input events, such as keyboard and mouse events, and returns the next event in the queue.
             * @return An SDL_Event representing the next user input event, or an empty event if no events are available.
             */
