 ...
 * The Camera2D class provides methods for calculating the view-projection matrix, moving the camera
 */
namespace graphics {
    class Camera2D {
        public:
            /**
             * @brief Calculates and returns the view-projection matrix for the camera, based on its position and zoom level.
             * @param screenWidth The width of the screen in pixels.
             * @param screenHeight The height of the screen in pixels.
             * @return A glm::mat4 representing the combined view and projection transformation for the camera
             */
             ...
             * Note: The direction vector should be scaled appropriately based on the current zoom level to achieve consistent movement speed
             */
            ...
            /**
             * @brief Converts screen coordinates (e.g., from mouse input) to world coordinates based on the camera's position and zoom level.
             * @param screenPos A glm::vec2 containing the x and y coordinates in screen space (origin at top-left corner).
             * @param screenWidth The width of the screen in pixels.
             * @param screenHeight The height of the screen in pixels.
             * @return A glm::vec2 containing the corresponding x and y coordinates in world space, taking into account the camera's position and zoom level.
             */
