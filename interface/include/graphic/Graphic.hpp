...
namespace graphic
{
    ...
    public:
        ...
        bool showHome = true;
        SpriteEditorData editorData = SpriteEditorData{Color{0, 0, 0, 255}, Color{0, 0, 0, 255}, std::vector<std::variant<light, solid, liquid, fire, flammable, sand>>{light{0, 0}}, std::vector<std::variant<light, solid, liquid, fire, flammable, sand>>{light{0, 0}}, false};
