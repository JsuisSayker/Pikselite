...
class Simulation
{
  public:
     ...
     */
    const std::vector<Element::Region>& getDetectedRegions() const
    {
     ...
     */
    const std::vector<b2BodyId>& getRegionBodies() const
    {
        return regionBodies;
    }
     ...
     */
    const std::vector<RegionBodyBinding>& getRegionBodyBindings() const
    {
        return regionBodyBindings;
    }
